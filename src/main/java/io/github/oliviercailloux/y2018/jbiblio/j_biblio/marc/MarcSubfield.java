...
public class MarcSubfield implements Subfield {
	 ...
	 */
	public MarcSubfield(final char code) {
		this.setCode(code);
	}

	/**
	 * Creates a new <code>Subfield</code> and sets the data element identifier and
	 * the data element.
	 * 
	 * @param code the data element identifier
	 * @param data the data element
	 */
	public MarcSubfield(final char code, final String data) {
		this.setCode(code);
		this.setData(data);
	}
	...
	/**
	 * Returns <code>true</code> is the supplied regular expression pattern matches
	 * the {@link Subfield} data; else, <code>false</code>.
	 */
	@Override
