...
public class MarcRecordImplementation implements Record {
	private Long id;
	 ...
	 * record already has a control number field, the field is replaced with the new
	 * instance.
	 *
	...
	/**
	 * Returns the control number field or <code>null</code> if no control number
	 * field is available.
	 *
	...
	/**
	 * Finds all the {@link VariableField}s that match the supplied tag and regular
	 * expression pattern.
	 */
	@Override
	...
	/**
	 * Finds all the {@link VariableField}s that match the supplied tags and regular
	 * expression pattern.
	 */
	@Override
	public List<VariableField> find(final String[] tag, final String pattern) {
